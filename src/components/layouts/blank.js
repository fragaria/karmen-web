...
const BlankLayout = ({ children }) => (
    <>
      ...
      >
        ...
        browsing or fill in the form, we consider that you accept its use
        and <a href="/documents/fragaria-privacy-policy.pdf" style={{ color: "#fff", textDecoration: "underline" }}>Fragaria Privacy Policy</a>
      </CookieConsent>
