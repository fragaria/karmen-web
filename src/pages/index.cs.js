...
const IndexPage = ({ data, location }) => {
  return (
    <Layout location={location}>
      ...
      <SEOBusinessInfo />
      <div className="content-block typeset v-home">
        <section className="hero hero--vertical" role="banner">
          <h1 className="hero__headline">
            Řešení na vzdálenou správu 3D tiskáren
          </h1>
          <h2 className="hero__sub">
            Management, monitoring a distribuce tiskových souborů kdykoliv a
            odkudkoliv
          </h2>
          <p className="hero__sub">
            Karmen umožňuje monitoring a správu jedné nebo více 3D tiskáren přes
            lokální síť nebo internet. Z webového prohlížeče vašeho počítače,
            tabletu či telefonu můžete zadávat tiskové úlohy, sledovat průběh
            tisku vrstvu po vrstvě, distibuovat tisk mezi více tiskárnami apod.
            Díky použitému softwarovému řešení je Karmen kompatibilní s širokou
            škálou tiskáren a slicerů.
          </p>
          <p className="hero__sub" id="subscribe">
            Ačkoliv oficiální spuštění proběhne v dubnu 2020, má Karmen již
            několik{" "}
            <a href="/#portfolio" className="anchor anchor--emphasized">
              uživatelů
            </a>{" "}
            z řad škol, coworkových dílen, firem a také jedna nemocnice.
          </p>
        </section>

        <section className="v-career-section career-teaser content-block__cover--mobile">
          <h1 className="career-teaser__headline">
            Informovat o Karmen novinkách
          </h1>
        ...
        <section className="v-home__portfolio">
          ...
          <div className="v-home__career-content article-typeset">
            <article>
              <h2>Karmen Pill</h2>
              <p>
                Kompaktní hardwarové zařízení Karmen Pill s integrovanou webovou
                kamerou, které se přes USB rozhraní připojí ke 3D tiskárně,
                zpřístupní ji do lokální sítě či internetu a zajistí tak její
                vzdálenou správu a obsluhu.
              </p>
              ...
              <ul>
                ...
                <li>
                  Uživatelské webové rozhraní pro monitoring: teplota senzorů,
                  probíhající tisk, obraz z vestavěné kamery
                </li>
                <li>
                  Základní ovládání tiskárny: (po)zastavení/spuštění tisku apod.
                </li>
            ...
            <article>
              ...
              <p>
                ...
                nástroj, v případě, že využijete naší hostované služby, máte
                provoz do určitého množství připojených tiskáren a objemu dat
                zdarma.
              </p>
              ...
              <ul>
                ...
                <li>
                  Otevřenou vývojářskou dokumentaci a API pro snadnou integraci
                  Karmen do jiných systémů
                </li>
              </ul>
            </article>
        ...
        <section className="v-home__company">
          ...
          <div className="v-home__career-content">
            <article className="contact v-home__company-about">
              <p>
                Oficiální spuštění a prodej plánujeme na duben 2020. Do té doby
                budeme rádi,{" "}
                <a href="/#subscribe" className="anchor anchor--emphasized">
                  pokud nám zanecháte svůj e-mail
                </a>
                , abychom Vás mohli informovat o našich novinkách.
              </p>
              <p>
                Zároveň je možné si rezervovat naše produkty přes jednoduchý
                formulář:
              </p>
            </article>

            <form
              className="v-home__company-contactform form"
              action={`"https://formspree.io/${data.site.siteMetadata.company.contactEmail}`}
              method="POST"
            >
        ...
        <section className="v-home__company">
          <h1 className="splitting-headline">
            <span className="splitting-headline__fill">
              Staň se beta testerem
            </span>
          </h1>
          <p className="v-home__career-content">
            Hledáme 10 testerů, kteří nám pomohou otestovat nové verze řešení
            Karmen ještě předtím, než budou vydány. Pro zařazení do programu
            prosíme o{" "}
            <a
              href="https://docs.google.com/forms/d/1h9rOmHEMIMAtg0ho2dCA9ATb3zRQHaagtCYbDF9XWnE/"
              className="anchor anchor--emphasized"
            >
