    ...
    <MainPageWrap lang="en" pageTitle="Welcome">
      <section className="hero hero--vertical" role="banner">
        ...
        <p className="hero__sub" id="subscribe">
          ...
          in various workloads—schools, makerspaces, companies and even in a
      ...
      <section className="v-career-section career-teaser content-block__cover--mobile">
        <h1 className="career-teaser__headline">
          Subscribe to latest Karmen news
        </h1>
      ...
      <section className="v-home__portfolio">
        ...
        <p className="v-home__career-content">
          Karmen is (and always will be) provided as an{" "}
          <a
        ...
        <div className="v-home__career-content article-typeset">
          <article>
            ...
            <ul>
              <li>
                Compatible with most slicers: Slic3r, PrusaSlicer, Ultimaker
                Cura etc.
              </li>
              <li>
                Monitoring at your fingertips: live video feed, temperature
                information, print progress
              </li>
          ...
          <article>
            ...
            <ul>
              <li>
                Monitor and manage connected printers using neat web interface
              </li>
              ...
              <li>
                Integrate Karmen into other systems by using an open API and
      ...
      <section className="v-home__company">
        ...
        <div className="v-home__career-content">
          <article className="contact v-home__company-about">
            ...
            <p>
              You can also pre-order our products using this simple web form:
            </p>
          </article>
          ...
          >
            ...
            <div className="form__line">
              <label className="form-label" for="git-name">
                Name
              </label>
            ...
            <div className="form__line">
              <label className="form-label" for="git-email">
                E-mail
              </label>
              <div className="form-control-wrapper">
                <input
            ...
            <div className="form__line">
              <label className="form-label" for="git-message">
                Your message
              </label>
              <div className="form-control-wrapper">
                <textarea
      ...
      <section className="v-home__company">
        ...
        <div className="v-home__career-content">
          <p>
            Karmen does not pick sides: we aim to help both individuals with a
            single hobby 3D printer and companies and organizations with their
            3D printer farms. And—contrary to other solutions—Karmen supports
            many different 3D printers brands.
          </p>
